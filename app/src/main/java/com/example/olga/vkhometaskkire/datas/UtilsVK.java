...
public class UtilsVK {
    ...
    public static void setList() {
        ...
        list.add(new User(1, User.SEX_WOMAN, "Olga", "Pelipets", "Olyalya", "Kharkov", "Ukraine",
                ...
                null, "В активном поиске жизненного счастья", null, true, true, true, true, true, 0, 0, new int[]{2, 3}, new int[]{1, 2}));
        ...
        list.add(new User(2, User.SEX_WOMAN, "Kate", "Djenkins", "Katyuha", "Kharkov", "Ukraine",
                ...
                null, "No Martini, no party.", null, true, true, true, true, true, 0, 0, new int[]{1, 3}, new int[]{1}));
        //user id=3
        list.add(new User(3, User.SEX_MAN, "Dennis", "Markins", "Den49", "Kiev", "Ukraine",
                new String[]{"photo9.jpg", "photo8.jpg", "photo7.jpg", "photo6.jpg"},
                null, "Life is speed", null, false, true, true, true, true, 0, 0, new int[]{1, 2, 4}, null));
        //user id=4
        list.add(new User(4, User.SEX_MAN, "Mark", "Petson", "BoyOk", "New York", "USA",
                new String[]{"photo10.jpg"},
                null, "bla bla bla", null, false, true, true, true, true, 0, 0, new int[]{3}, new int[]{2}));
    ...
    public static void setListVideo(ArrayList<VideoRecord> listVideo) {
        UtilsVK.listVideo = listVideo;
    }
